...
?>
                                ...
                                <div class="row align-items-center my-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Total Products
       ...
       $pt = mysqli_num_rows($results);
        ?>
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Total News Articles
       ...
       $pt = mysqli_num_rows($results);
        ?>
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Total Active Blogs
                                                    </p>
                                                    <?php
        $sql = "select * from blogs where active='1'";
        $results = $connect->query($sql);
       $pt = mysqli_num_rows($results);
        ?>
                                                    <span class="h2 mb-0"><?php echo $pt; ?></span>
                                            ...
                                            <div class="col-6">
                                                <div class="p-4">
                                                    <p class="small text-uppercase text-muted mb-0">Total Posts
